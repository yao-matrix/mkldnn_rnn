...
constexpr auto kMkldnnRNNParamsCanonical = R"doc(
...
weight allocation and initialization should use this size.
                         ...
                         kMkldnnRNNCommonInputs, kMkldnnRNNCommonAttrs,
                         R"doc(
params_size: The size of the params buffer that should be allocated and
    initialized for this RNN model. Note that this params buffer may not be
    compatible across GPUs. Please use MkldnnRNNParamsWeights and
    MkldnnRNNParamsBiases to save and restore them in a way that is compatible
    across different runs.
)doc",
                         kMkldnnRNNParamsBuffer));
...
buffer.
                         ...
                         kMkldnnRNNCommonAttrs, MkldnnRNNForwardTensors(),
                         R"doc(
